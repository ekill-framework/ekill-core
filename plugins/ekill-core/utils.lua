...
---@param player Player
---@return boolean
Core.Utils.IsPlayerValid = function (player --[[Player]])
    return player ~= nil
...
---@return boolean
Core.Utils.IsPlayerIdValid = function (playerID --[[number]])
    local player = GetPlayer(playerID)
    return Core.Utils.IsPlayerValid(player)
end

---Check if the round is pistol
---@return boolean
Core.Utils.IsPistolRound = function()
...
---@return boolean
Core.Utils.IsWarmupPeriod = function()
    local gameRules = GetCCSGameRules()
    if gameRules == nil then return false end
...
---@return boolean
Core.Utils.HasPlayerWeapon = function(player --[[Player]], weaponName --[[string]] )
...
---@param teamID Team
---@return number|nil
Core.Utils.GetTeamScore = function(teamID)
...
--- Team : https://swiftlycs2.net/docs/scripting/types/core/team.html
Core.Utils.GetCPlantedC4 = function()
...
---@return boolean
--- Team : https://swiftlycs2.net/docs/scripting/types/core/team.html
Core.Utils.IsBombPlanted = function()
    local plantedBomb = Core.Utils.GetCPlantedC4()
...
---@return boolean
Core.Utils.IsBombPlantedSide = function(bombSideId)
    local plantedBomb = Core.Utils.GetCPlantedC4()
    if plantedBomb == nil then return false end
...
---@return integer
Core.Utils.CalculateDistanceBetweenVector = function(vector1 --[[Vector]], vector2 --[[Vector]])
...
Core.Utils.SendToPlayer = function(prefix --[[string]], messageType --[[MessageType]], player --[[Player]], message --[[string]])
...
---@param messageType MessageType
---@param message string
Core.Utils.SendToAllPlayers = function(prefix --[[string]], messageType --[[MessageType]], message --[[string]])
    if prefix == nil or prefix == "" then prefix = config:Fetch("ekill-core.prefix") end
